    ...
    >
      ...
      <div className="text-updater-node">
        <div className="text-sm w-full flex flex-col p-2 ">
          <p className="text-[10px] font-bold text-center">AWS</p>

          {AwsData && (
            <div>
              <label htmlFor="fileSelect" className="text-[10px]">Select File:</label>
              <select
                id="fileSelect"
                name="fileSelect"
                onChange={handleSelectedFile}
                className="nodrag mt-2 text-[10px] bg-white border border-gray-300 rounded-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-400 block w-full p-1 width-[150px]"
                style={{ width: '120px', fontSize: '10px' }}
              >
                <option value="" className="text-[10px]">Select a file</option>
