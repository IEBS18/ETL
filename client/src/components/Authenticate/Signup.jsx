...
function Signup({ onSwitchToLogin }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('http://54.196.201.194:5000/signup', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                localStorage.setItem('user_minex_id', data.user_minex_id);
                localStorage.setItem('first_name_minex_user', data.first_name);
                navigate('/ETL');
            } else {
